export default function Loading() {
  return (
    <>
      ...
      <div style={{ width: '100%', maxWidth: '800px', aspectRatio: '16/9', position: 'relative', borderRadius: '12px', backgroundColor: '#f1f5f9', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px', marginBottom: '32px' }}>
